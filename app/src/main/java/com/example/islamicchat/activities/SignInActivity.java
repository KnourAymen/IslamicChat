...
import com.example.islamicchat.R;
import com.example.islamicchat.databinding.ActivitySignInBinding;
...
public class SignInActivity extends AppCompatActivity {
    ...
    private Boolean isValidSignInDetails() {
        if (activitySignInBinding.inputEmail.getText().toString().trim().isEmpty()) {
            ...
            return false;
        } else if (!Patterns.EMAIL_ADDRESS.matcher(activitySignInBinding.inputEmail.getText().toString().trim()).matches()) {
    ...
    private void loading(Boolean isLoading) {
        if (isLoading) {
            activitySignInBinding.btnSignIn.setVisibility(View.INVISIBLE);
