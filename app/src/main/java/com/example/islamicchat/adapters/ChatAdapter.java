package com.example.islamicchat.adapters;
...
import com.example.islamicchat.databinding.ItemContainerReceivedMessageBinding;
import com.example.islamicchat.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    static class SentMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(ChatMessage chatMessage) {
            binding.messageTextView.setText(chatMessage.message);
